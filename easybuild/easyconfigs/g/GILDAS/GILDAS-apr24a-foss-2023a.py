...
local_binary = [
    'astro', 'build-vsop87', 'chopper-test', 'class', 'classdemo-telwrite', 'classic-demo-read', 'classic-demo-write', 'classic-dump', 'classic-read',
    'cube', 'f2f90', 'flux','gag-format-f90.pl', 'gag-get-interfaces.pl',
    'gag-makedepend.pl', 'gag-parse-messages.pl', 'greg', 'hershey', 'hlp2tex',
'imager', 'iram-planet', 'mapping', 'mira', 'mrtcal', 'orbit', 'point',
    'sic', 'telcal', 'viewer'
]

sanity_check_paths = {
    'files': ['x86_64-rocky8.9-gfortran/bin/%s' % x for x in local_binary] +     ['lib/libgtk-4.%s' % SHLIB_EXT],
